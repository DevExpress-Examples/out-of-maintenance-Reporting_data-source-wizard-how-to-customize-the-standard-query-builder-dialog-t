...
Namespace ReplaceQueryBuilderSample
    Friend Class MyConfigureQueryPage(Of TModel As {Class, ISqlDataSourceModel})
        ...
        Protected Overrides Function RunQueryBuilder(ByVal query As SqlQuery) As SqlQuery
            ...
            If selectQuery IsNot Nothing AndAlso selectQuery.Tables.Count = 1 AndAlso selectQuery.Columns.Count = 1 AndAlso String.IsNullOrEmpty(selectQuery.FilterString) AndAlso selectQuery.Skip = 0 Then
            ...
            If String.IsNullOrEmpty(tableName) Then
                Return Nothing
            End If
            Dim result As SqlQuery = SelectQueryFluentBuilder.AddTable(tableName).SelectAllColumns().Top(topRecords).Build(tableName)
